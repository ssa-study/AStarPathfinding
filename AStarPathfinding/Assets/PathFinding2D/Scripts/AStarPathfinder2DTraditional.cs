...
{
    // グリッドベースのPathFinder
    public class AStarPathfinder2DTraditional : AStarPathfinder2DGrid
    {
        public static AStarPathfinder2DTraditional Instance;

        void Awake()
        {
            AStarPathfinder2DTraditional.Instance = this;
        }
